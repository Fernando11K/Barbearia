        ...
        <q-dialog v-model="statusModal" persistent>
            <q-card class="my-card">
                ...
                <q-card-actions align="right" class="text-primary col-12 row justify-around">
                    <q-btn v-close-popup @click="atualizaStatusModalExternamente()" rounded icon="fa-solid fa-xmark" color="negative" label="Sair" class="col-5" />
...
const atualizaStatusModalExternamente = () =>{ 
    emits('atualizaStatusModal', false)
